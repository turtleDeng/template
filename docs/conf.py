...
copyright = u'2016-2017, 邓海贵, 杭州映云科技有限公司'
...
latex_documents = [
  ('index', 'EMQX.tex', u'EMQ - 百万级开源MQTT消息服务器',
...
man_pages = [
    ('index', 'emqtt', u'长虹物联网平台消息系统安装部署说明书',
     [u'邓海贵 <turtled@emqtt.io>'], 1)
]
...
texinfo_documents = [
  ('index', 'EMQX', u'长虹物联网平台消息系统安装部署说明书',
